.class public interface abstract Landroid/app/IProfileManager;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/app/IProfileManager$Stub;
    }
.end annotation
...
.method public abstract addProfile(Landroid/app/Profile;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getActiveProfile()Landroid/app/Profile;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getProfile(Landroid/os/ParcelUuid;)Landroid/app/Profile;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getProfileByName(Ljava/lang/String;)Landroid/app/Profile;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract getProfiles()[Landroid/app/Profile;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract removeProfile(Landroid/app/Profile;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract updateProfile(Landroid/app/Profile;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
